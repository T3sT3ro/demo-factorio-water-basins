...
function grad2(hash: number, x: number, y: number): number {
  const grad2lut: readonly [readonly [number, number], readonly [number, number], readonly [number, number], readonly [number, number], readonly [number, number], readonly [number, number], readonly [number, number], readonly [number, number]] = [
    [1, 1],
    [-1, 1],
    [1, -1],
    [-1, -1],
  ...
  return grad2lut[hash as 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7][0] * x + grad2lut[hash as 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7][1] * y;
}
...
export class NoiseSettings {
  ...
  updateUI() {
    ...
    const noiseTypeEl = document.getElementById("noiseType") as HTMLInputElement | null;
    const warpEl = document.getElementById("noiseWarpStrength") as HTMLInputElement | null;
    const warpIterationsEl = document.getElementById("noiseWarpIterations") as HTMLInputElement | null;
    ...
    const freqValueEl = document.getElementById("noiseFreqValue") as HTMLElement | null;
    const octavesValueEl = document.getElementById("noiseOctavesValue") as HTMLElement | null;
    const persistenceValueEl = document.getElementById("noisePersistenceValue") as HTMLElement | null;
    const lacunarityValueEl = document.getElementById("noiseLacunarityValue") as HTMLElement | null;
    const offsetValueEl = document.getElementById("noiseOffsetValue") as HTMLElement | null;
    const gainValueEl = document.getElementById("noiseGainValue") as HTMLElement | null;
    const warpValueEl = document.getElementById("noiseWarpStrengthValue") as HTMLElement | null;
    const warpIterationsValueEl = document.getElementById("noiseWarpIterationsValue") as HTMLElement | null;
...
export class HeightGenerator {
  ...
  generate(seedOffset: number = 0): number[][] {
    ...
    let noiseFunc: (x: number, y: number) => number;
